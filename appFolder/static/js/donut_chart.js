$.ajax({
         type: "GET",
         url: "http://127.0.0.1:5000/donutdata",
         contentType : "application/json",
         success : function(data){
            function colores_google(n) {
                  var colores_g = ["#dd4477", "#66aa00", "#ff9900", "#316395","#006633"];
            ...
            function DonutCharts() {
               ...
               // var color = function(i){ return colores_google(i);}
                    ...
                    var eventObj = {
                        ...
                        'mouseover': function(d, i, j) {
                            ...
                            thisDonut.select('.value').text(function(donut_d) {
                                return d.data.val.toFixed(1) +" #"+ d.data.cat;
                            });
